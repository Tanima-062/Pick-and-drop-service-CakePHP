...
<div class="client_campaigns form">
	<?php
            echo $this->Form->create(
                'ClientCampaign',array('type' => 'file', action => 'add'));
	?>
            
	<h3>クライアントキャンペーン追加</h3>
        <table class="table table-bordered table-striped table-hover" style="font-size:small">
	 <tr>
	  <th class="span3"  >タイトル</th>
	  <td>
             <?php  
                if( $this->Form->Error('ClientCampaign.title')){
                    echo $this->Form->input('title', array( "label" => false, "div" => false, "style" => "width:300px; border-color:red;"));
            ?>
            <span style='color:red;'>
            </span> <?php
                } else { 
                    echo $this->Form->input('title', array("label" => false, "style" => "width:300px;"));
                }
             ?>
          </td>
         </tr>
	  ...
	  <td>
           <?php
                ...
                echo $this->Form->textarea("overview", array("cols"=>20, "rows"=>5, 'style' => array('width:100%;box-sizing:border-box;min-height:200px;border-color:red;'))); 
            ?>
            <span style='color:red;'>
            <?php    
            ...
            ?></span> <?php
                    ...
                    echo $this->Form->textarea("overview", array("cols"=>20, "rows"=>5, 'style' => array('width:100%;box-sizing:border-box;min-height:200px;')));
                }
            ?>               
          </td>
         </tr>
	  ...
	  <td>
           ...
           <?php
                ...
                echo $this->Form->textarea("list_explanation", array("cols"=>20, "rows"=>5, 'style' => array('width:100%;box-sizing:border-box;min-height:200px;border-color:red;'))); 
            ?>
            <span style='color:red;'>
            <?php    
            ...
            ?></span> <?php
                    ...
                    echo $this->Form->textarea("list_explanation", array("cols"=>20, "rows"=>5, 'style' => array('width:100%;box-sizing:border-box;min-height:200px;')));
                }
            ?>              
          </td>
         </tr>
	  ...
	  <td>
           <?php
                if( $this->Form->Error('ClientCampaign.vehicle_fee_example') ){
                    echo $this->Form->textarea("vehicle_fee_example", array("cols"=>20, "rows"=>5, 'style' => array('width:100%;box-sizing:border-box;min-height:200px;border-color:red;'))); 
           ?>
            <span style='color:red;'>
            <?php    
            ...
            ?></span> <?php
                    ...
                    echo $this->Form->textarea("vehicle_fee_example", array("cols"=>20, "rows"=>5, 'style' => array('width:100%;box-sizing:border-box;min-height:200px;')));
                }
            ?>
...
　        <th class="span3">画像ファイル1</th>
	  <td>
            <?php echo $this->Form->input('image1', array( "div" => false, 'type' => 'file', 'label' => false)); ?>
          </td>
         </tr>
         <tr>
　        <th class="span3">画像ファイル2</th>
	  <td>
            <?php echo $this->Form->input('image2', array( "div" => false, 'type' => 'file', 'label' => false)); ?>
          </td>
         </tr>
         <tr>
　        <th class="span3">画像ファイル3</th>
	  <td>
            <?php echo $this->Form->input('image3', array( "div" => false, 'type' => 'file', 'label' => false)); ?>
          </td>
         <tr>
　        <th class="span3">サムネイル画像</th>
	  <td>
            <?php echo $this->Form->input('thumbnail_image', array("div" => false,  'type' => 'file', 'label' => false)); ?>              
          </td>
         </tr>
         <tr>
　        <th class="span3">優先順位</th>
	  <td><?php echo $this->Form->input('rank', array("div" => false,  'value' => '1', 'label' => false, 'min' => '1', 'max' => '10' )); ?></td>
         </tr>
         <tr>

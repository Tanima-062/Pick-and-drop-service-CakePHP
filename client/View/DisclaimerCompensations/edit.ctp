...
<h3><?php echo __('編集 免責補償料金'); ?></h3>
<div>
	<p style="text-align:right;"><?php echo $this->Html->link(__('一覧へ戻る'), array('action' => 'index'), array('class' => 'btn btn-warning')); ?></p>
</div>
...
<?php echo $this->Form->button('保存', array('type' => 'submit', 'class' => 'btn btn-success')); ?>
<?php echo $this->Form->end(); ?>

<div style="text-align: right;">
	<?php echo $this->Form->postLink(__('削除'), array('action' => 'delete', $this->Form->value('DisclaimerCompensation.id')), array('class' => 'btn btn-danger'), __('削除してもよろしいでしょうか # %s?', $this->Form->value('DisclaimerCompensation.id'))); ?>
</div>

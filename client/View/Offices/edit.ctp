<div class="offices form">
	...
	<h3>営業所編集</h3>
	<?php
	echo $this->Form->input('id', array('label' => 'ID', 'div' => false));
	echo $this->Form->input('OfficeSupplement.id', array('value' => $this->request->data['OfficeSupplement'][0]['id'], 'div' => false));
	?>
	<table class="table table-bordered">
		...
		<tr>
			...
			<td>
				...
				<div>
					最寄り交通機関　　　
					<?php echo $this->Form->input('OfficeSupplement.nearest_transport', array('type' => 'radio', 'options' => $nearestTransportOptions, 'value' => $nearestTransport, 'legend' => false, 'label' => false, 'div' => false, 'style' => 'display:inline;')); ?>
					<?php echo $this->Form->input('OfficeSupplement.other_transport', array('value' => $this->request->data['OfficeSupplement'][0]['other_transport'], 'label' => false, 'div' => false, 'style' => 'display:inline;')); ?>
				</div>
				...
				<div>
					交通手段　　　
					<?php echo $this->Form->input('OfficeSupplement.method_of_transport', array('type' => 'radio', 'options' => $methodOfTransportOptions, 'value' => $methodOfTransport, 'legend' => false, 'label' => false, 'div' => false, 'style' => 'display:inline;')); ?>
				</div>
				...
				<div>
					上記交通手段での所要時間　　　
					<?php echo $this->Form->input('OfficeSupplement.required_transport_time', array('min' => 0, 'max' => 999, 'value' => $this->request->data['OfficeSupplement'][0]['required_transport_time'], 'label' => false, 'div' => false, 'required', 'class' => 'span2')); ?>
					<?php echo "分"; ?>
				</div>
		...
		<tr id="meet-and-greet">
			...
			<td>
				...
				<div>
					送迎待ち時間　　　
					<?php echo "通常期　"; ?>
					<?php echo $this->Form->input('OfficeSupplement.pickup_wait_time', array('min' => 0, 'max' => 999, 'value' => $this->request->data['OfficeSupplement'][0]['pickup_wait_time'], 'label' => false, 'div' => false, 'class' => 'span2')); ?>
					<?php echo "分　　繁忙期　"; ?>
					<?php echo $this->Form->input('OfficeSupplement.pickup_wait_time_busy', array('min' => 0, 'max' => 999, 'value' => $this->request->data['OfficeSupplement'][0]['pickup_wait_time_busy'], 'label' => false, 'div' => false, 'class' => 'span2')); ?>
					<?php echo "分"; ?><br>
				</div>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<?php echo "通常期　"; ?>
				<?php echo $this->Form->input('OfficeSupplement.rent_proc_time', array('min' => 1, 'max' => 999, 'value' => $this->request->data['OfficeSupplement'][0]['rent_proc_time'], 'label' => false, 'div' => false, 'required', 'class' => 'span2')); ?>
				<?php echo "分　　繁忙期　"; ?>
				<?php echo $this->Form->input('OfficeSupplement.rent_proc_time_busy', array('min' => 1, 'max' => 999, 'value' => $this->request->data['OfficeSupplement'][0]['rent_proc_time_busy'], 'label' => false, 'div' => false, 'required', 'class' => 'span2')); ?>
				<?php echo "分"; ?>
			</td>
		</tr>
		<tr>
			...
			<td>
				<?php echo "通常期　"; ?>
				<?php echo $this->Form->input('OfficeSupplement.return_proc_time', array('min' => 1, 'max' => 999, 'value' => $this->request->data['OfficeSupplement'][0]['return_proc_time'], 'label' => false, 'div' => false, 'required', 'class' => 'span2')); ?>
				<?php echo "分　　繁忙期　"; ?>
				<?php echo $this->Form->input('OfficeSupplement.return_proc_time_busy', array('min' => 1, 'max' => 999, 'value' => $this->request->data['OfficeSupplement'][0]['return_proc_time_busy'], 'label' => false, 'div' => false, 'required', 'class' => 'span2')); ?>
				<?php echo "分"; ?>
			</td>
		</tr>
		...
		<tr>
			...
			<?php echo $this->Form->hidden('OfficeStockGroup.id', array('label' => 'ID', 'div' => false, 'value' => $officeStocks['OfficeStockGroup']['id'])); ?>
			<?php echo $this->Form->hidden('OfficeStockGroup.office_id', array('label' => 'ID', 'div' => false, 'value' => $this->request->data['Office']['id'])); ?>
			<td><?php echo $this->Form->input('OfficeStockGroup.stock_group_id', array('label' => false, 'div' => false, 'empty' => '---', 'options' => $stocks, 'default' => @$this->request->data['OfficeStockGroup'][0]['stock_group_id'], 'required' => true)); ?></td>
		</tr>

		<tr>
			<th  class="alert-success">対応都道府県/エリア</th>
			<td><?php echo $this->Form->input('Office.area_id', array('label' => false, 'div' => false, 'empty' => '---', 'type' => 'select', 'options' => $area, 'default' => 2, 'class' => 'office_area_id', 'required' => true)); ?></td>
		</tr>
		<?php if ($is_system_admin == 1) { ?>
			<tr>
				<th  class="alert-success">対応市区町村</th>
				<td><?php echo $this->Form->input('city_id', array('label' => false, 'div' => false, 'empty' => false, 'type' => 'select', 'options' => $cityList, 'required')); ?><code>　※郵便番号に対応する市区町村が自動的に設定されます。候補が複数ある場合、リストから選択してください。</code></td>
			</tr>
		<?php } ?>
		<tr>
			<th  class="alert-success">乗捨対象エリア</th>
			<td><?php echo $this->Form->input('area_drop_off_id', array('options' => $dropOffAreaList, 'label' => false, 'empty' => '---')); ?></td>
		</tr>
		...
		<tr>
			...
			<td><?php echo $this->Form->input('latitude', array('label' => false, 'div' => false, 'required' => true)); ?></td>
		</tr>
		<tr>
			<th  class="alert-success">経度</th>
			<td><?php echo $this->Form->input('longitude', array('label' => false, 'div' => false, 'required' => true)); ?></td>
		</tr>
		<?php if ($is_system_admin == 1) { ?>
			<tr>
				<th  class="alert-success">リンク用URL</th>
				<td><?php echo $this->Form->input('url', array('label' => false, 'pattern' => Constant::PATTERN_LINKCD, 'div' => false)); ?></td>
			</tr>
		<?php } ?>
		<tr>
	...
	$(function () {
		...
		$('input[name="data[OfficeSupplement][pickup_method]"]').change(function () {
			...
			if (method == 0 || method == 3) {
				...
				$('#pickup-call').hide();
				//$('#OfficeSupplementNeedPickupCall0').prop('checked', true);
			}
		});
		...
		$('#OfficeSupplementMethodOfTransport<?php echo $methodOfTransport; ?>').trigger('change');
		// 所要時間

...
レンタカー追加代金お支払いの期限がせまっております。
お支払い期限を過ぎると、 ご予約は自動的にキャンセルとなります。 
本メールを必ず最後までご確認の上、期限内にご入金手続きをお願いいたします。

■ お支払い期限

<?php echo $Reservation['payment_limit_datetime']; ?>
...
※ 本メールとお客様のご入金手続きが行き違いとなる場合がございますがご容赦ください。 

※ やむを得ず期限内にお支払いいただけない場合は、スカイチケットレンタカーサポートセンターまでお問い合わせください。

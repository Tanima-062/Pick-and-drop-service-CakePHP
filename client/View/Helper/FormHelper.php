 ...
 */
	public function create($model = null, $options = array()) {
		...
		$inputCurrentClientId = '';
		if(isset($this->_View->viewVars['is_check_user']) && $this->_View->viewVars['is_check_user']){
			
			if(isset($this->_View->viewVars['currentClientId'])){
				$currentClientId = $this->_View->viewVars['currentClientId'];
				$inputCurrentClientId = $this->hidden('Custom.current_client_id', array('value' => $currentClientId));
			}
		}

		return $this->Html->useTag('form', $action, $htmlAttributes) .$inputCurrentClientId . $append;
	}

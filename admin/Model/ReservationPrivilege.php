 ...
 */
	...
	public function getReservationPrivilege($reservationId) {
		$options = array(
				'conditions' => array(
		...
		$reservationPrivilege = $this->find('all', $options);
		$result = Hash::extract($reservationPrivilege, '{n}.ReservationPrivilege');
		return $result;
	}
}

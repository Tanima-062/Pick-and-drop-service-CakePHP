<div class="tourprices edit">
	...
	<table class="table table-bordered">
		...
		<tr>
			<th>車両クラス名</th>
			<td id="dispCarTypeName"><?php echo $this->request->data['TourPrice']['tour_car_type_name']; ?></td>
		</tr>
		<tr>
			<th>車種（例）</th>
			<td id="dispCarExample"><?php echo $this->request->data['TourPrice']['tour_car_example']; ?></td>
		</tr>
		<tr>
			<th>販売単価</th>

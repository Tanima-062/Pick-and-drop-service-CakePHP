<div class="carModels form">
	...
	<?php echo $this->Form->hidden('Custom.referer', array('value' => $referer)); ?>
		<h3><?php echo __('車種マスタ新規追加'); ?></h3>
		<table class="table table-bordered">
			<tr>
				<th class="span3">自動車メーカーID</th>
				<td>
				<?php echo $this->Form->input('automaker_id',array('label'=>'自動車メーカーID', 'options' => $automakerList)); ?>
				</td>
			</tr>
		<tr>
			<th>車種名</th>
		...
		<tr>
			<th>推奨荷物の数</th>
			<td>
				<?php echo $this->Form->input('package_num',array('required' => true)); ?>
			</td>
		</tr>
		<tr>
			<th>燃費</th>
			<td>
				<?php echo $this->Form->input('mileage',array('required' => true)); ?>
			</td>
		</tr>
		<tr>
			<th>ドア数</th>
			<td>
				<?php echo $this->Form->input('door',array('required' => true)); ?>
			</td>
		</tr>
		<tr>
			<th><?php echo $this->Form->label('image_relative_url','画像　例：横幅300pxに変換'); ?> </th>
			<td>

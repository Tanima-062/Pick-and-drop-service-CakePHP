 ...
 */
	public function write($name, $value = null) {
		return CakeSession::write(SERVICE_CD_RC . '.' . $name, $value);
	}
 ...
 */
	public function read($name = null) {
		return CakeSession::read(SERVICE_CD_RC . '.' . $name);
	}
 ...
 */
	public function delete($name) {
		return CakeSession::delete(SERVICE_CD_RC . '.' . $name);
	}
 ...
 */
	public function consume($name) {
		return CakeSession::consume(SERVICE_CD_RC . '.' . $name);
	}
 ...
 */
	public function check($name) {
		return CakeSession::check(SERVICE_CD_RC . '.' . $name);
	}

...
つきましては、ご予約のレンタカー情報と、ご利用方法をお送りいたします。
...
<?php if(!empty($rent_office_start_day) && !empty($rent_office_end_day)): ?>

　※ <?php echo $rent_office_start_day.'~'.$rent_office_end_day; ?> は営業時間が通常と異なります。詳細は店舗へお問い合わせください。
<?php endif ?>
...
<?php if(!empty($return_office_start_day) && !empty($return_office_end_day)): ?>

　※ <?php echo $return_office_start_day.'~'.$return_office_end_day; ?> は営業時間が通常と異なります。詳細は店舗へお問い合わせください。
<?php endif ?>

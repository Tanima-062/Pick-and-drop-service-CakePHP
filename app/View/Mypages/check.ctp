<div id="renewal" class="login-edit login wrap contents clearfix mypages-check_page">
<?php if (!empty($this->data['Reservation']['contents'])) { ?>
	<h2 class="h-type03">お問い合わせ内容</h2>
<?php } else { ?>
	<h2 class="h-type03">変更内容</h2>
<?php } ?>
...
<article id="plan-detail" class="box-outer">
	 ...
	 ?>
		<tr>
			...
			<td>
				...
				　→　
				<b><?php echo $this->data['Reservation']['email']; ?>
				<?php echo $this->Form->hidden('email', array('value' => h($this->data['Reservation']['email']))); ?></b>
			</td>
		</tr>
	<?php } ?>
	...
	?>
		<tr>
			...
			<td>
				...
				　→　
				<b><?php echo $this->data['tel']; ?>
				<?php echo $this->Form->hidden('edit_tel', array('value' => $this->data['tel'])); ?></b>
			</td>
		</tr>
	<?php } ?>

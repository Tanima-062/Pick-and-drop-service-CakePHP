...
<?php
		echo $this->Form->checkbox('car_type[]', array('id' => 'select_option_chk' . $val['id'], 'value' => $val['id'], 'hiddenField' => false, 'default' => $default, 'class'=>'form-checkbox'));
?>
                <label for="select_option_chk<?= $val['id'] ?>">
...
<?php
		echo $this->Form->checkbox('option[]',array('id'=>'select_option_chk_'.$optionKey,'value'=>$optionKey,'hiddenField'=>false,'default'=>$default, 'class'=>'form-checkbox'));

		echo '<label for="select_option_chk_' . $optionKey . '"\>' . htmlspecialchars($val) . '</label>';
?>
            </li>
<?php

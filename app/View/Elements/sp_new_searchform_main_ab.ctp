<div class="new_searchform_main_section ab">

	<section class="searchform_main_datetime-ab">
		<!-- 出発日時 -->
		<div class="select_datetime_wrap">
			<p class="select_datetime_title">出発日時</p>
			<div class="select_datetime_form">
		...
		<!-- 返却日時 -->
		<div class="select_datetime_wrap">
			<p class="select_datetime_title">返却日時</p>
			<div class="select_datetime_form">
				<fieldset class="input-form -small">
					<div class="field-wrap icon-left select_date_box">
						<?php
...
?>
	...
	<div class="return_way_checkbox">
		<input id="return_way_check_ab" class="form-return_way_input form-checkbox" type="checkbox" value="1" checked="checked" />
		<label for="return_way_check_ab">
				出発店舗へ返却
